...
export const SignUp = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            setloading(true)
            const response = await axios.post(`${apiUrl}api/user/${active ? "register-user" : "login-user"}`, formData);
    ...
    return (
        <div className="signUpWrapper">
            ...
            <div className="signup">
                ...
                <p className="alternate" >{active ? "Already have an account?" : "New to BastionEx?"} <span onClick={() => setActive(!active)}>{active ? "Login" : " Create account"}</span></p>
