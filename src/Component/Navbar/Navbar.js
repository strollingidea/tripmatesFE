      ...
      <div id="navContainer" >
        <div className="navbar">
          <div className='leftSide'>
            ...
            <div className="menu" onClick={()=>menuHandler()}><label><i class="fa-solid fa-bars"></i><span> Menu</span></label></div>
            <div className="mobMenu" onClick={()=>mobMenuHandler()}><label><i class="fa-solid fa-bars"></i></label></div>
          </div>
